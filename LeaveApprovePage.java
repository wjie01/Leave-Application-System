...
public class LeaveApprovePage {
    ...
    public LeaveApprovePage() {
        ...
        for (int i = 0; i < leaves.length; i++) {
            if (leaves[i][0] != null) {
				JLabel labelRB = new JLabel("  " + leaves[i][0] + " | " + leaves[i][1] + " | " + leaves[i][2] + " | " + leaves[i][3] + " | " + leaves[i][4] + "  ");
				labelRB.setFont(new Font("Arial", Font.BOLD, 15));
				labelRB.setBorder(BorderFactory.createLineBorder(Color.black));
                panel.add(labelRB);
        ...
        refreshButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < leaves.length; i++) {
                    if (leaves[i][0] != null) {
						JLabel labelRefreshB = new JLabel("  " + leaves[i][0] + " | " + leaves[i][1] + " | " + leaves[i][2] + " | " + leaves[i][3] + " | " + leaves[i][4]);
						labelRefreshB.setFont(new Font("Arial", Font.BOLD, 15));
						labelRefreshB.setBorder(BorderFactory.createLineBorder(Color.black));
                        panel.add(labelRefreshB);
